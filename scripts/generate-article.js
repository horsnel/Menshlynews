 ...
 * - Full markdown content matching the Menshlynews format (2500+ words)
 ...
 *   node scripts/generate-article.js "AI Drop Servicing Business" "Side Hustles" "How to build..."
 * 
 * Or see suggestions:
...
async function generateContent(title, category, excerpt, forceLonger = false) {
  ...
  try {
    ...
    console.log(`   ⚠️  z-ai-web-dev-sdk failed: ${err.message}`);
  }
...
function insertPostIntoDataTs(post) {
